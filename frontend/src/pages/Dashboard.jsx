...
import { LucideFilePlus, LucidePlus, LucideTrash2, MonitorSmartphone } from 'lucide-react'
...
import moment from 'moment' 
  ...
  return (
    <DashboardLayout>
      ...
      {/* Create Model */}
      <Model isOpen={openCreateModel} onClose={() => setOpenCreateModel(false)} hideHeader maxWidth="max-w-2xl">
        <div className='p-6'>
