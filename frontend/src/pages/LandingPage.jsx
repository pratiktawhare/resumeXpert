...
import { ArrowRight, Download, LampDesk, LanguagesIcon, LayoutTemplate, LucideBadgeIndianRupee, Menu, User, X, Zap } from 'lucide-react';
            ...
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                ...
                <p className={landingPageStyles.ctaDescription}>
                  Join thousands of professionals who landed their dream jobs with out platform
                </p>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            Crafted with <span className={landingPageStyles.footerHeart}>❤️</span> by Pratik
          </p>
        </div>
      </footer>
